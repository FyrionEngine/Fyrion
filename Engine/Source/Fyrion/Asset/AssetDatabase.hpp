...
namespace Fyrion
{
    ...
    public:
        ...
        static void            ImportAsset(AssetDirectory* directory, const StringView& path, AssetTransaction* transaction);
        ...
        static void            Destroy(Asset* asset, AssetTransaction* transaction, bool destroySubobjects = true);\
